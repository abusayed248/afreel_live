                                    ...
                                    <div id="collapseOne" class="accordion-collapse collapse show"
                                        ...
                                        <div class="accordion-body">
                                            <div class="form-check">
                                                <input class="form-check-input" @isset($developmentWebLogical){{ $developmentWebLogical
                                                    ? 'checked' : '' }} @endisset type="checkbox" name="job_category[]"
                                                    value="Développement Web et Logiciel" id="flexCheckDefault">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" @isset($marketingEtVente){{ $marketingEtVente
                                                    ? 'checked' : '' }} @endisset type="checkbox" name="job_category[]"
                                                    value="Marketing et Vente" id="flexCheckChecked">
                                                <label class="form-check-label" for="flexCheckChecked">
                                                    Marketing et Vente
                                                </label>
                                            </div>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" @isset($servicesTecnic){{ $servicesTecnic ? 'checked' : ''
                                                    }} @endisset type="checkbox" name="job_category[]"
                                                    value="Services Techniques" id="flexCheckChecked">
                                                <label class="form-check-label" for="flexCheckChecked">
                                                    Services Techniques
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" @isset($photographieEtVidéographie){{ $photographieEtVidéographie ? 'checked'
                                                    : '' }} @endisset type="checkbox" name="job_category[]"
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" @isset($santéEtBienêtre){{ $santéEtBienêtre ? 'checked' : '' }}
                                                    @endisset type="checkbox" name="job_category[]"
                                                    value="Santé et Bien-être" id="flexCheckChecked">
                                                <label class="form-check-label" for="flexCheckChecked">
                                                    Santé et Bien-être
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" @isset($ArtetDivertissement){{ $ArtetDivertissement
                                                    ? 'checked' : '' }} @endisset type="checkbox" name="job_category[]"
                                                    value="Art et Divertissement" id="flexCheckChecked">
                                                <label class="form-check-label" for="flexCheckChecked">
                                                    Art et Divertissement
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" @isset($ÉducationetTutorat){{ $ÉducationetTutorat
                                                    ? 'checked' : '' }} @endisset type="checkbox" name="job_category[]"
                                                    value="Éducation et Tutorat" id="flexCheckChecked">
                                                <label class="form-check-label" for="flexCheckChecked">
                                                    Éducation et Tutorat
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" @isset($ConstructionetRénovation){{ $ConstructionetRénovation ? 'checked'
                                                    : '' }} @endisset type="checkbox" name="job_category[]"
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" @isset($LogistiqueetTransport){{ $LogistiqueetTransport ? 'checked' : ''
                                                    }} @endisset type="checkbox" name="job_category[]" value="Logistique et Transport"
                                                    id="flexCheckChecked">
                                                <label class="form-check-label" for="flexCheckChecked">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" @isset($PlomberieetÉlectricité){{
                                                    $PlomberieetÉlectricité ? 'checked' : '' }} @endisset type="checkbox"
                                                    name="job_category[]" value="Plomberie et Électricité"
                                                    id="flexCheckChecked">
                                                <label class="form-check-label" for="flexCheckChecked">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" @isset($SécuritéetSurveillance){{
                                                    $SécuritéetSurveillance ? 'checked' : '' }} @endisset type="checkbox"
                                                    name="job_category[]" value="Sécurité et Surveillance"
                                                    id="flexCheckChecked">
                                                <label class="form-check-label" for="flexCheckChecked">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" @isset($MaintenanceetRéparationÉquipements){{
                                                    $MaintenanceetRéparationÉquipements ? 'checked' : '' }} @endisset type="checkbox"
                                                    name="job_category[]" value="Maintenance et Réparation d'Équipements"
                                                    id="flexCheckChecked">
                                                <label class="form-check-label" for="flexCheckChecked">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" @isset($EvénementieletAnimation){{
                                                    $EvénementieletAnimation ? 'checked' : '' }} @endisset type="checkbox"
                                                    name="job_category[]" value="Evénementiel et Animation"
                                                    id="flexCheckChecked">
                                                <label class="form-check-label" for="flexCheckChecked">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" @isset($BricolageetPetitsTravaux){{
                                                    $BricolageetPetitsTravaux ? 'checked' : '' }} @endisset type="checkbox"
                                                    name="job_category[]" value="Bricolage et Petits Travaux"
                                                    id="flexCheckChecked">
                                                <label class="form-check-label" for="flexCheckChecked">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" @isset($BabysittingetGardedEnfants){{
                                                    $BabysittingetGardedEnfants ? 'checked' : '' }} @endisset type="checkbox"
                                                    name="job_category[]" value="Baby-sitting et Garde d'Enfants"
                                                    id="flexCheckChecked">
                                                <label class="form-check-label" for="flexCheckChecked">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" @isset($EnseignementetFormation){{
                                                    $EnseignementetFormation ? 'checked' : '' }} @endisset type="checkbox"
                                                    name="job_category[]" value="Enseignement et Formation"
                                                    id="flexCheckChecked">
                                                <label class="form-check-label" for="flexCheckChecked">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" @isset($DéveloppementPersonnel){{
                                                    $DéveloppementPersonnel ? 'checked' : '' }} @endisset type="checkbox"
                                                    name="job_category[]" value="Développement Personnel"
                                                    id="flexCheckChecked">
                                                <label class="form-check-label" for="flexCheckChecked">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" @isset($RédactiondeCVetLettresdeMotivation){{
                                                    $RédactiondeCVetLettresdeMotivation ? 'checked' : '' }} @endisset type="checkbox"
                                                    name="job_category[]" value="Rédaction de CV et Lettres de Motivation"
                                                    id="flexCheckChecked">
                                                <label class="form-check-label" for="flexCheckChecked">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" @isset($GraphismeetIllustration){{
                                                    $GraphismeetIllustration ? 'checked' : '' }} @endisset type="checkbox"
                                                    name="job_category[]" value="Graphisme et Illustration"
                                                    id="flexCheckChecked">
                                                <label class="form-check-label" for="flexCheckChecked">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" @isset($EcommerceetDropshipping){{
                                                    $EcommerceetDropshipping ? 'checked' : '' }} @endisset type="checkbox"
                                                    name="job_category[]" value="E-commerce et Dropshipping"
                                                    id="flexCheckChecked">
                                                <label class="form-check-label" for="flexCheckChecked">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" @isset($BienêtreetSpa){{
                                                    $BienêtreetSpa ? 'checked' : '' }} @endisset type="checkbox"
                                                    name="job_category[]" value="Bien-être et Spa"
                                                    id="flexCheckChecked">
                                                <label class="form-check-label" for="flexCheckChecked">
                                                    Bien-être et Spa
                                                </label>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" @isset($AccompagnementetServicesauxPersonnesÂgées){{
                                                    $AccompagnementetServicesauxPersonnesÂgées ? 'checked' : '' }} @endisset type="checkbox"
                                                    name="job_category[]" value="Accompagnement et Services aux Personnes Âgées"
                                                    id="flexCheckChecked">
                                                <label class="form-check-label" for="flexCheckChecked">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" @isset($ArchitectureetDesigndIntérieur){{
                                                    $ArchitectureetDesigndIntérieur ? 'checked' : '' }} @endisset type="checkbox"
                                                    name="job_category[]" value="Architecture et Design d'Intérieur"
                                                    id="flexCheckChecked">
                                                <label class="form-check-label" for="flexCheckChecked">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" @isset($ProductionetRéalisationAudiovisuelle){{
                                                    $ProductionetRéalisationAudiovisuelle ? 'checked' : '' }} @endisset type="checkbox"
                                                    name="job_category[]" value="Production et Réalisation Audiovisuelle"
                                                    id="flexCheckChecked">
                                                <label class="form-check-label" for="flexCheckChecked">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" @isset($RestaurationetHôtellerie){{
                                                    $RestaurationetHôtellerie ? 'checked' : '' }} @endisset type="checkbox"
                                                    name="job_category[]" value="Restauration et Hôtellerie"
                                                    id="flexCheckChecked">
                                                <label class="form-check-label" for="flexCheckChecked">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" @isset($DécorationetAmeublement){{
                                                    $DécorationetAmeublement ? 'checked' : '' }} @endisset type="checkbox"
                                                    name="job_category[]" value="Décoration et Ameublement"
                                                    id="flexCheckChecked">
                                                <label class="form-check-label" for="flexCheckChecked">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" @isset($RecrutementetChassedeTêtes){{
                                                    $RecrutementetChassedeTêtes ? 'checked' : '' }} @endisset type="checkbox"
                                                    name="job_category[]" value="Recrutement et Chasse de Têtes"
                                                    id="flexCheckChecked">
                                                <label class="form-check-label" for="flexCheckChecked">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" @isset($GestiondePropriétésImmobilières){{
                                                    $GestiondePropriétésImmobilières ? 'checked' : '' }} @endisset type="checkbox"
                                                    name="job_category[]" value="Gestion de Propriétés Immobilières"
                                                    id="flexCheckChecked">
                                                <label class="form-check-label" for="flexCheckChecked">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" @isset($ProgrammationetAutomatisation){{
                                                    $ProgrammationetAutomatisation ? 'checked' : '' }} @endisset type="checkbox"
                                                    name="job_category[]" value="Programmation et Automatisation"
                                                    id="flexCheckChecked">
                                                <label class="form-check-label" for="flexCheckChecked">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" @isset($ServicedeTraductionetInterprétation){{
                                                    $ServicedeTraductionetInterprétation ? 'checked' : '' }} @endisset type="checkbox"
                                                    name="job_category[]" value="Service de Traduction et Interprétation"
                                                    id="flexCheckChecked">
                                                <label class="form-check-label" for="flexCheckChecked">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" @isset($IntelligenceArtificielleetMachineLearning){{
                                                    $IntelligenceArtificielleetMachineLearning ? 'checked' : '' }} @endisset type="checkbox"
                                                    name="job_category[]" value="Intelligence Artificielle et Machine Learning"
                                                    id="flexCheckChecked">
                                                <label class="form-check-label" for="flexCheckChecked">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" @isset($ServicesPhotographiques){{
                                                    $ServicesPhotographiques ? 'checked' : '' }} @endisset type="checkbox"
                                                    name="job_category[]" value="Services Photographiques"
                                                    id="flexCheckChecked">
                                                <label class="form-check-label" for="flexCheckChecked">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" @isset($RechercheetDéveloppement){{
                                                    $RechercheetDéveloppement ? 'checked' : '' }} @endisset type="checkbox"
                                                    name="job_category[]" value="Recherche et Développement"
                                                    id="flexCheckChecked">
                                                <label class="form-check-label" for="flexCheckChecked">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" @isset($DesigndeMode){{
                                                    $DesigndeMode ? 'checked' : '' }} @endisset type="checkbox"
                                                    name="job_category[]" value="Design de Mode"
                                                    id="flexCheckChecked">
                                                <label class="form-check-label" for="flexCheckChecked">
                                                    Design de Mode
                                                </label>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" @isset($GestiondesDéchetsetRecyclage){{
                                                    $GestiondesDéchetsetRecyclage ? 'checked' : '' }} @endisset type="checkbox"
                                                    name="job_category[]" value="Gestion des Déchets et Recyclage"
                                                    id="flexCheckChecked">
                                                <label class="form-check-label" for="flexCheckChecked">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" @isset($BiensdeConsommationetRetail){{
                                                    $BiensdeConsommationetRetail ? 'checked' : '' }} @endisset type="checkbox"
                                                    name="job_category[]" value="Biens de Consommation et Retail"
                                                    id="flexCheckChecked">
                                                <label class="form-check-label" for="flexCheckChecked">
                                        ...
                                        <div class="accordion-body">
                                            <div class="form-check">
                                                <input class="form-check-input" @isset($fulltime){{ $fulltime
                                                    ? 'checked' : '' }} @endisset name="job_type[]" value="à temps plein"
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" @isset($parttime){{ $parttime
                                                    ? 'checked' : '' }} @endisset name="job_type[]" value="à temps partiel"
                        ...
                        <div class="p-2 recet_job_con d-flex  align-items-center flex-wrap mt-3">
                            ...
                            <div class="col-md-4 d-flex justify-content-end align-items-center">
                                <a class=" recet_job_apply_btn bc"
                                    href="{{ route('job.post.details', ['slug' => $job->slug, 'id' => $job->id]) }}">Postuler à un emploi<i class="fa-regular fa-circle-right"></i></a>
                            </div>
                        </div>
                        @endforeach
