...
Route::middleware('auth:admin')->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('all/enterprises', [EnterpriseController::class, 'index'])->name('all.enterprises');
    Route::get('enterprises/{id}', [EnterpriseController::class, 'destroy'])->name('enterprises.destroy');
