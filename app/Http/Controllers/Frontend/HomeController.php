...
class HomeController extends Controller
{
    ...
    public function findJobs(Request $request)
    {
        ...
        $Beggins = in_array("Beggin's", $request->input('career_level', []));
        $moyen = in_array('moyen', $request->input('career_level', []));
        $experte = in_array('experte', $request->input('career_level', []));
